...
| 4C Frontend Interaction & Authority | [phases/4c-frontend-interaction-and-authority-realization.md](phases/4c-frontend-interaction-and-authority-realization.md) | exact operation/wire or frontend owner reference only when the current interaction needs it | Product code, 4D/runtime choices, broad research |
