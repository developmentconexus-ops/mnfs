...
Accepted ADRs record durable architectural choices. Their semantic outcome is not rewritten; later changes use a superseding ADR.
...
- [ADR-0006 — Security planes and local execution isolation](0006-security-planes-and-local-execution-isolation.md)
- [ADR-0007 — Credential Grants and External Effects](0007-credential-grants-and-external-effects.md)
- [ADR-0008 — Reproducible and remote Execution Environments](0008-reproducible-and-remote-execution-environments.md)
...
Copy [the template](template.md), assign the next number and open a reviewable proposal. Use an ADR only for an architecturally significant and durable choice.
