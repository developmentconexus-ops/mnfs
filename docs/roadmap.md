...
| Product implementation | BLOCKED | Accepted Realization Planning must be integrated and a separate explicit operator execution grant is still required; no planning/merge approval carries forward | No historical authorization carries forward |
