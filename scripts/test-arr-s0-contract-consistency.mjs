...
assert.match(documentationMap, /DOC-ARR-S1-AGENT-RUNTIME-CONTRACT/u, 'Documentation Map must expose downstream S1 contract discovery without selecting a runtime');
assert.match(documentationMap, /DOC-ARR-S2-EXECUTION-ENVELOPE-CONTRACT/u, 'Documentation Map must expose downstream S2 contract discovery without selecting an environment');
