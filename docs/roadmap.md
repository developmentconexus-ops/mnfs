...
4C = OPEN / ACTIVE / 4C-4+5 ACCEPTED FOR PROGRESSION / 4C-F01 RESOLVED / GF-01 HTML LO-FI CANDIDATE
4D–4G = NOT STARTED
...
Operator visual/interactive adjudication of the [`GF-01` low-fidelity HTML global-frame candidate](evidence/4c/gf01-global-frame-wireframe.html) against the [structural hypotheses](evidence/4c/gf01-structural-hypotheses.md).

Current Conexus 4C P8 medium decision: structural wireframes are viewable **HTML/CSS lo-fi** artifacts, with bounded vanilla JavaScript only when needed to inspect navigation/responsive structure; static SVG/image is not the current wireframe authority.
