...
| Realization Planning / first build | [phases/realization-planning.md](phases/realization-planning.md) | one owning reference named by the concrete slice | Product implementation history, unrelated qualification |
