...
4C = OPEN / ACTIVE / 4C-4+5 ACCEPTED FOR PROGRESSION / 4C-F01 RESOLVED / GF-01 RENDERED CANDIDATE
4D–4G = NOT STARTED
...
Operator visual adjudication of the [`GF-01` rendered global-frame candidate](evidence/4c/gf01-global-frame-wireframe.svg) against the [structural hypotheses](evidence/4c/gf01-structural-hypotheses.md).
