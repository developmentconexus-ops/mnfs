...
| 4C Frontend Interaction & Authority | [phases/4c-frontend-interaction-and-authority-realization.md](phases/4c-frontend-interaction-and-authority-realization.md) | [product/operation-ledger.md](product/operation-ledger.md) and [product/wire-contract.md](product/wire-contract.md) for exact operation/wire trace; [reference/frontend-and-product-surfaces.md](reference/frontend-and-product-surfaces.md) for accepted semantic surfaces; then one exact owner/security/Product reference only when a concrete interaction requires it | Product implementation, 4D Paved Road/runtime selection, broad design research before a named UX ambiguity |
...
| Product Agents / runtime | [reference/runtime-and-agents.md](reference/runtime-and-agents.md) | [reference/mastra/index.md](reference/mastra/index.md); for current PAR streaming/leverage questions add [evidence/4b/technology-leverage-and-par-streaming-review.md](evidence/4b/technology-leverage-and-par-streaming-review.md) | qualification unless requalifying |
