...
Use the following complete test structure. The production change that makes these tests pass is the existence of `runProcess` with exact raw-byte, timeout, output-limit and spawn-failure semantics.
