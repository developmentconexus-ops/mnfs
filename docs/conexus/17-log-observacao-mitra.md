...
> **O que é.** Diário de campo da [sonda de manutenção](16-sonda-manutencao-mitra.md), alimentado em
...
> contradiz o [mapa congelado v0.9.0](../research/MITRA-INSPIRATION-MAP.md), a contradição é
...
`data-v-4ad65ef8`. Evidência verbatim: [`evidence/mitra-agent-question.html`](evidence/mitra-agent-question.html).
...
**O que muda no mapa.** O mapa registra `AskUserQuestion` como **tool** ([§22](../research/MITRA-INSPIRATION-MAP.md),
[§31](../research/MITRA-INSPIRATION-MAP.md)) e discute a regra de "última ação do turno". **Não registrava
...
**O que muda no mapa.** [§585](../research/MITRA-INSPIRATION-MAP.md) registrou o oposto — naquele build
...
design*. Continua valendo o **STRENGTHEN** de [01-harness-agentico](../reference/mitra/01-harness-agentico.md):
...
chegou colado no chat. É o **S4** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md), e
...
**O que muda no mapa.** Nada — [§4 do mapa](../research/MITRA-INSPIRATION-MAP.md) já lista o catálogo
idêntico. **Confirmação**, não novidade. O detalhe operacional que importa hoje: existe blueprint
**Sandbox** separado do de produção, coerente com [§606](../research/MITRA-INSPIRATION-MAP.md)
...
Não é bug da Mitra — é consequência do modelo BYOK/BYOS ([§28](../research/MITRA-INSPIRATION-MAP.md)).
...
**O que muda no mapa.** Confirma [§07 padrão de projeto](../reference/mitra/07-padrao-de-projeto.md)
...
**O que muda no mapa.** [§26.7](../research/MITRA-INSPIRATION-MAP.md) já listava os frames
...
plataforma, e o doc [01-harness-agentico](../reference/mitra/01-harness-agentico.md) generaliza
...
| `GET /api/mitra-agent/promote/{ws}/{proj}/status?userId=` | **404** | endpoint sim ([§27](../research/MITRA-INSPIRATION-MAP.md)); o 404 é novo — projeto sem promote ainda |
...
"perfil de ERP" que [04-integracao-externa](../reference/mitra/04-integracao-externa.md) propõe como
...
ERP versionado" que [04-integracao-externa](../reference/mitra/04-integracao-externa.md) propõe como
...
**O que muda no mapa.** [§ pendências do mapa](../research/MITRA-INSPIRATION-MAP.md) registrava
...
**Leitura para o Conexus.** Confirma [§34.11 do mapa](../research/MITRA-INSPIRATION-MAP.md)
...
**O que muda no mapa.** [§11.5 / §31](../research/MITRA-INSPIRATION-MAP.md) afirma, duas vezes:
...
**O que muda no mapa.** [§26.7](../research/MITRA-INSPIRATION-MAP.md) lista o frame recebido
...
**Veredito Conexus — REJECT o padrão.** Confirma a hipótese central da [sonda](16-sonda-manutencao-mitra.md):
...
que o próprio ecossistema Mitra usa (e que aparece no [mapa congelado](../research/MITRA-INSPIRATION-MAP.md)).
O modelo escreveu contra um contrato que **já existiu** e não vale mais na versão que está instalada.
Isto é exatamente **O1/O2** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) — versionamento
...
**Contradição com o mapa congelado.** [§34](../research/MITRA-INSPIRATION-MAP.md) descreve o agente
...
camadas do [T9](00-TOPICOS.md): discovery de ERP deveria virar **artefato reutilizável e cacheado**,
...
**Enquadramento.** Este é o **V1** do [roteiro do tópico 16](16-sonda-manutencao-mitra.md): brief de
...
é log de aplicação. O [mapa congelado](../research/MITRA-INSPIRATION-MAP.md) e o
[T13](00-TOPICOS.md) tratam observabilidade como *log de turno + custo*; esta camada é outra coisa e
...
Fecha a pergunta do [T6](00-TOPICOS.md) (Postgres × MySQL) do lado da evidência: **MySQL**.
...
Isso reposiciona a leitura competitiva do [T1](02-visao-escopo.md) e não está no mapa v0.9.0.
...
Limite operacional novo, não registrado no [mapa](../research/MITRA-INSPIRATION-MAP.md): execução de
...
[sonda](16-sonda-manutencao-mitra.md) precisa flagrar. **A verificar quando o build fechar.**
...
todo projeto real esbarra nisto no primeiro dia. Alimenta o [tópico 4](00-TOPICOS.md) — sandbox.
...
[08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) de gap conhecido para **risco medido**.
...
com o código"* da [sonda](16-sonda-manutencao-mitra.md). E se recusou a poluir o banco com rascunho de
...
[08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md). Proponho **S9 — credencial de runtime de
...
**Por que este turno é o M1/M3 da [sonda](16-sonda-manutencao-mitra.md) e o pedido do operador ao mesmo
...
teto de 10 min ([OBS-32](#)), fecha o quadro do [tópico 4](00-TOPICOS.md): ambiente **efêmero por
...
[16-sonda](16-sonda-manutencao-mitra.md).
...
[sonda](16-sonda-manutencao-mitra.md).
...
[tópico 4](00-TOPICOS.md): sandbox efêmero + execução em segundo plano é combinação viável.
...
Isso é [T5](00-TOPICOS.md), [T13](00-TOPICOS.md) e [T14](00-TOPICOS.md), e é o esqueleto do veredito
de [16-sonda](16-sonda-manutencao-mitra.md).
...
recebem `null`. Nossa [referência de integração externa](../reference/mitra/04-integracao-externa.md)
...
Sobe **O1/O2** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) para o gap mais bem
...
O [roteiro da sonda](16-sonda-manutencao-mitra.md) reserva o turno **M2** para justamente isto:
...
Isto **confirma S1** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) — *"SQL por
...
bind parameters reais no [T5](00-TOPICOS.md)/[T14](00-TOPICOS.md) — e nota: quem o produziu foi a
...
## OBS-47 — A Mitra tem uma camada semântica (dimensão / cubo) — e ela mira o [T15](00-TOPICOS.md)
...
[tópico 15](00-TOPICOS.md) — *"Cérebro da empresa: camada semântica por grupo de projetos:
...
Espelha exatamente o **E1** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) (vazio /
...
parcial de [16](16-sonda-manutencao-mitra.md): a plataforma não pede nada disso.
...
[08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md) (*"smoke test contra produção… só seguro
...
| Métrica (doc [16](16-sonda-manutencao-mitra.md)) | Resultado M1 | Evidência |
|---|---|---|
...
- **`cmd && echo ok` reporta sucesso do `echo`, não do `cmd`.** O agente pegou, mas o padrão está no
  ambiente e vai enganar quem não conferir. Reforça **E2/O5** ([08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md)):
...
O sandbox é **recriado a cada turno** ([04-runtime-agente](04-runtime-agente.md)). Um commit que só
...
[08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md).** Eu tratei o `{{param}}` como
...
**Isto conflita com o E6** de [08-limites-e-gaps](../reference/mitra/08-limites-e-gaps.md)
...
**Consequência para o [T13](00-TOPICOS.md) — e é a mais direta da noite:** não precisamos *inventar*
...
- **`allows_public_screen`** — existe flag de tela pública no runtime publicado. Vai direto para o
  [T12](00-TOPICOS.md), e conversa com o **S9** (JWT no fragmento da URL de preview): se há tela
...
Ironia útil para o [tópico 5](00-TOPICOS.md): **o detector de artefato órfão — a melhor invariante da
...
degrau abaixo de credencial gerenciada. **Novo gap.** Ver [`08`](../reference/mitra/08-limites-e-gaps.md).
...
dele. É um argumento direto para a camada semântica do [T15](00-TOPICOS.md): *"OAuth authorization
